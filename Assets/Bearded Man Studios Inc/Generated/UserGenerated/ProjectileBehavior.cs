...
{
	[GeneratedRPC("{\"types\":[[][\"byte\", \"Vector2\", \"Vector2\"]]")]
	[GeneratedRPCVariableNames("{\"types\":[[][\"playerID\", \"position\", \"direction\"]]")]
	public abstract partial class ProjectileBehavior : NetworkBehavior
	{
		public const byte RPC_DIE = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("Shoot", Shoot, typeof(byte), typeof(Vector2), typeof(Vector2));
